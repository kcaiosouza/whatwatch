...
$sql = "UPDATE `users` SET `photoURL`= 'https://www.whatwatch.live/account/api/uploads/".$_SESSION['user']['id_user']."_".$_SESSION['user']['login'].".png' WHERE `user_id` = ".$_SESSION['user']['id_user']."";
$update = mysqli_query($conn, $sql);
$_SESSION['user']['photoURL'] = "https://www.whatwatch.live/account/api/uploads/".$_SESSION['user']['id_user']."_".$_SESSION['user']['login'].".png";
header("Location: ../");